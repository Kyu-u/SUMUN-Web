            ...
            <nav class="bg-main-0 py-10 text-white font-navbar font-medium relative z-10">
                ...
                <div id="navitems" class="max-w-7xl mx-auto items-center grid grid-cols-9 hidden lg:grid relative z-10">
                    ...
                    <div class=" justify-center flex relative w-full">
                        ...
                        <div id="dropdown"
                            class="hidden absolute top-6 flex-col bg-signup-0 w-auto mt-1 justify-center ">
                    ...
                    <div class=" justify-self-center flex relative">
                        ...
                        <div id="dropdown3"
                            class="hidden absolute top-6 flex-col bg-signup-0 w-32  mt-1 justify-center">
                    ...
                    <div id="navitems" class="col-span-1 justify-self-start flex gap-4  items-center">
                ...
                <form method="POST" action="{{route('logout1')}}"
                    class="justify-self-start flex gap-4  col-span-1 items-center hover:text-signup-0 transition duration-300">
                    @csrf
                    <button type="submit" class="w-full pl-4">
                        Logout
                    </button>
                </form>
        ...
        ">
                ...
                <div class="flex items-center justify-center md:justify-between mx-auto max-w-7xl relative">
                    ...
                    <div class="hidden md:flex justify-evenly items-center">
                        ...
                        <img class="w-1/5" src="images/ig.png" alt="" /><img class="w-1/5" src="images/mail.png"
                            alt="" />
                    </div>
                </div>
            </footer>
