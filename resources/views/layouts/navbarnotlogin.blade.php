...
<div class="flex flex-col justify-between items-end">
  ...
  <footer class="relative bg-main-0 ">
      ...
      ">
            ...
            <div class="flex flex-col text-foot-0 font-sans w-1/2 md:w-1/4 justify-center items-center md:items-start md:justify-start h-36">
            ...
            <div class="flex flex-col text-foot-0 font-sans w-1/4 md:w-1/6 justify-center md:justify-start items-center md:items-start h-36">
                <div class="font-semibold text-xl pb-6">About</div>
                <div class="text-xs font-thin text-center md:text-left">
                    Line : @sumunmantap <br />
