...
<!-- START NO REK-->
<div class="bg-main-0 pt-40 md:pt-20">
    <div class="mx-auto max-w-7xl">


        <div class="flex flex-col md:flex-row pb-10 items-center justify-center">
...
<div class="bg-main-0 flex flex-col px-2 md:px-20  justify-center py-10 md:py-40 "">
    ...
    <div class="flex flex-col">
        ...
        <div class="flex flex-row items-center pt-2">
            ...
            <label class="text-xxs md:text-base text-white px-2 sm:px-4 " for="webinar">Bukti Pembayaran
                Webinar</label>
        </div>
    ...
    <div class="text-white">
        ...
        <input class="cursor-pointer absolute block opacity-0 pin-r pin-t" type="file" name="verifImage"
            accept="fileName" multiple>
    </div>
</div>
