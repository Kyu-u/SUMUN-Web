...
<div class="flex flex-col items-center">
        ...
        <div class="relative w-full h-full flex-1 rounded-3xl bg-gradient-to-r from-signup-0 to-tableisi-0 p-10">
            ...
            <form action="{{route('regis2')}}" method="POST" class="pt-2 sm:pt-5 flex flex-row ">
                ...
                <div class="flex flex-col w-4/7">
                    ...
                    <input class="text-black outline-none px-3 w-full lg:w-1/2 rounded-md text-sm py-1 sm:py-4 "
                    ...
                    <input class="text-black outline-none px-3 w-full lg:w-1/2 rounded-md text-sm py-1 sm:py-4 "
                        type="text" id="council" name="council" placeholder="Your Council...">
    ...
    <div class="relative flex justify-center mx-auto w-6/7 h-96 sm:h-97 sm:w-97  md:w-98 lg:w-99">
        ...
        <div class="relative w-full h-full flex-1 rounded-3xl bg-gradient-to-r from-signup-0 to-tableisi-0 p-10 text-white">
