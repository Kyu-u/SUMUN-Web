...
<div class="bg-main-0">
    ...
    <div class="max-w-7xl pt-36 mx-auto relative pb-20">
        ...
        <div class="font-sans text-white text-xl pt-8">
            <h2>
                Pendaftaran dibuka
                <span class="font-bold">15-17 Juni 2021</span>. Pilih acara yang
                ingin diikuti.
            </h2>
        </div>
        <div class="flex gap-14 pt-16">
            ...
            >
                ...
                >
                    <p>
                        apa aja boleh ini apa aja sumpah engga ngadi-ngadi
                        terserah deh isi apa deskripsi kek apa kek bebas bos
                        lanjot.apa aja boleh ini apa aja sumpah engga
                        ngadi-ngadi terserah deh isi apa deskripsi kek apa kek
                        bebas bos lanjot.apa aja boleh ini apa aja sumpah engga
                        ngadi-ngadi terserah deh isi apa deskripsi kek apa kek
                        bebas bos lanjot.apa aja boleh ini apa aja sumpah engga
                        ngadi-ngadi terserah deh isi apa deskripsi kek apa kek
                        bebas bos lanjot.apa aja boleh ini apa aja sumpah engga
                        ...
                        >
                            <tbody>
                                <tr
                                    class="
                                        text-center
                                        font-medium font-judul
                                        text-3xl
                                        h-16
                                    "
                                >
                                    <td class="bg-time-0 rounded-md w-1/4">
                                        Time
                                    </td>
                                    <td class="bg-timelinebot-0 rounded-md">
                                        Day
                                    </td>
                                    <td class="bg-timelinebot-0 rounded-md">
                                        Day
                                ...
                                <tr class="text-center h-12">
                                    ...
                                    <td rowspan="2" class="bg-tableisi-0">
                                        Webinar AZIK
                                    </td>
                                </tr>
                                <tr class="text-center h-12">
                                ...
                                <tr class="text-center h-12">
                                    ...
                                    <td class="bg-tableisi-0" rowspan="2">
                                        Webinar AZIK
                                    </td>
                                </tr>
                                <tr class="text-center h-12">
    ...
    <footer class="relative">
        ...
        />
        <div
            class="flex items-center justify-between mx-auto max-w-7xl relative"
        >
