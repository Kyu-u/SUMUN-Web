...
<section class="py-40 flex flex-col justify-center bg-main-0  mx-auto w-full px-4 sm:px-0 relative">
        ...
        <div class=" max-w-7xl mx-auto px-2 sm:px-10 w-72 go:w-96 sm:w-97 bg-cardprofile-0 border-border-0 border-4 rounded-3xl relative z-10">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center pt-32 relative z-10">
            ...
            <a href="#" class="w-auto bg-cardprofile-0 h-auto text-white px-6 py-4 rounded-lg hover:bg-signup-0 transform transition duration-300">
                Zoom MUN
            </a>
        ...
        <div class="px-0 md:px-10 py-10 md:py-0">
            ...
            <a href="#" class="w-auto bg-cardprofile-0 h-auto text-white px-6 py-4 rounded-lg hover:bg-signup-0 transform transition duration-300" download>
                Download RoP
            </a>
