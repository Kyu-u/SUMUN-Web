          ...
          <h1 class="text-6xl mt-14" style="background: #57CA85;
            ...
            <div class="flex flex-col w-full md:w-2/3 pt-6 md:pt-0">
              <form class="flex flex-col py-10" action="" method="">
                <label class="pb-2 text-xs nd:text-sm" for="Email" class="">New Passowrd</label>
                <input class="rounded-lg md:w-full px-4 py-2 text-sm md:text-sm  text-xl text-black" type="password" id="password" name="passowrd"
                  placeholder="*******">
                  <label class="pb-2 text-xs nd:text-sm pt-6" for="Email" class="">Confirm new password</label>
                <input class="rounded-lg md:w-full px-4 py-2 text-sm md:text-sm  text-xl text-black" type="password" id="password_confirmation" name="passowrd_confirmation"
                placeholder="*******">
              </form>
