      ...
      <div class="bg-main-0 py-36 flex justify-center text-white relative grid grid-cols-1 px-60">
        ...
        <div class="absolute text-xl text-white top-1/16 left-1/2">
          ...
          <form class="flex flex-col" action="{{ route('login') }}" method="post">
            ...
            <input class="rounded-lg lg:w-60 xl:w-96 px-4 py-2 lg:text-sm xl:text-xl" type="text" id="email" name="email" placeholder="example@example.com">
            <label class="py-2 text-sm"for="Password">Password</label>
            <input class="rounded-lg lg:w-60 xl:w-96 px-4 py-2 lg:text-sm xl:text-xl" type="password" id="password" name="password" placeholder="example@example.com">
            ...
            <a class="lg:pl-36 xl:pl-70  text-white hover:text-signup-0 lg:text-xs xl:text-sm pt-4" href="">Forgot possword?</a>
