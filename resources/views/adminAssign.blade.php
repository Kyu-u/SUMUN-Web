...
<div class="flex flex-col items-center">
  ...
  <div class="relative flex justify-center mx-auto w-6/7 h-80 sm:h-97 sm:w-97  md:w-98 lg:w-99">
    ...
    <div class="relative w-full h-full rounded-3xl bg-gradient-to-r from-signup-0 to-tableisi-0 p-5 md:p-10 text-white">


      <div class="pt-2 sm:pt-5 flex flex-row">
        <form action="{{route('adminAssign')}}" method="GET" class=" ">
          @csrf
